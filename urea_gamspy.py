...
i.setRecords(['CH4','CO','CO2','H2','N2','NH3','urea'])  # index i goes over the compounds
...
yields = gams.Parameter(container=m,
                              name='yields',
                              domain=j,
...
stoich_lesser = gams.Parameter(container=m,
                        name='stoich_lesser',
                        domain=[i,j],
...
stoich_greater = gams.Parameter(container=m,
                        name='stoich_greater',
                        domain=[i,j],
                        description='stoichiometric coefficient of compound i in reaction j',
...
throughput_lesser = gams.Parameter(container=m,
...
throughput_greater = gams.Parameter(container=m,
                            name='throughput_lesser',
                            domain=i,
                            description='throughput of compound i in process when >= 0'
                           )
...
throughput_lesser_const = gams.Equation(container=m,
                                 name='throughput_lesser_const',
                                 domain=i,
                                 description='throughput of compound i when <= 0'
                                )

throughput_greater_const = gams.Equation(container=m,
