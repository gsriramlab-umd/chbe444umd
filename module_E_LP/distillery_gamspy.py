...
# For this LP:
# z = 5 x1 + 10 x2 (x1 = weekly production of ale in gal/wk,
#                   x2 = weekly production of bourbon in gal/wk,
#                   z is in dollars/wk)
# Constraints:
# 0.05 x1 + 0.10 x2 <= 150
# 0.10 x1 + 0.05 x2 <= 150
...
# Profit is per 100 gal, so prices in problem were multiplied by 100
