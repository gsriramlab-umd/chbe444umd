...
graph_html = des.desmos_graph(expressions=expressions,sliders=sliders,points=points,
                              axlim=[-100,2000,-100,2000],size=[1000,400])
...
# # Use the command (note the javascript=True option):
# graph_html,expr_java = des.desmos_graph(expressions=expressions,sliders=sliders,points=points,
#                                         axlim=[-100,2000,-100,2000],size=[1000,400],javascript=True)

# # Print the list of expressions (expr_java) returned by the function:
# print(expr_java)
# # Open the Desmos graphing calculator, press Ctrl+Shft+J (Cmd+Shft+J on Mac) to access the Desmos console
# # Paste the list of expressions into the console and press Enter
# # Some browsers or computers may ask you to type "allow paste" before you paste expressions into the console
